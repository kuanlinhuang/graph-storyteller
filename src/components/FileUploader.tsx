...
export const FileUploader = ({
  ...
  return <div className="space-y-6">
      ...
      <Card className="shadow-card-custom">
        ...
        <CardContent className="space-y-4">
          {/* Drag and Drop Zone */}
          <div className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${dragOver ? 'border-primary bg-primary/5' : 'border-border hover:border-primary/50'}`} onDrop={handleDrop} onDragOver={e => {
          e.preventDefault();
          setDragOver(true);
            ...
            <Input type="file" accept=".json,application/json" onChange={handleInputChange} className="w-full max-w-xs mx-auto" />
          </div>
  ...
  "edges": [
    {"id": "e1", "source": "1", "target": "2", "label": "connection"}
      ...
      {/* Current Data Info */}
      {currentData && <Card className="shadow-card-custom">
          <CardHeader>
